...
import { Share2, DollarSign, MessageSquare, Bookmark, Calendar, BarChart, Tag, Award, AlertCircle, ArrowLeft, Zap, Globe, Star } from 'lucide-react';
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="flex items-center space-x-4 mt-6">
                      ...
                      <div className="relative flex items-center">
                        ...
                        {showShareMenu && (
                          <motion.div 
                            id="share-menu" 
                            className="absolute z-50 left-full top-1/2 -translate-y-1/2 ml-2 backdrop-blur-xl bg-black/40 border border-white/10 rounded-xl shadow-2xl p-3 flex flex-row gap-2 min-w-[40px]"
            ...
            <div className="space-y-8">
              ...
              >
                <GlassCard className="p-8" hover={false}>
                  <h3 className="text-xl font-bold text-white mb-6">Similar Ideas</h3>
